class Item < ApplicationRecord
  ...
  validates :price, presence: true, numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 9999999, message: 'Out of setting range' ,with: /\A[0-9]+\z/, message: 'Half-width number'}
